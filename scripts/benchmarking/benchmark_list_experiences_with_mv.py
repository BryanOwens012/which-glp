#!/usr/bin/env python3
"""
Benchmark: List experiences using materialized view

This script benchmarks the experiences.list query that queries the
mv_experiences_denormalized materialized view with filtering, sorting, and pagination.
...
def main():
    ...
    print("Benchmarking list experiences using materialized view...\n")

    # Query that lists experiences with filters, sorting, and pagination
    # This simulates: GET /api/experiences?drug=Ozempic&limit=20&sortBy=date&sortOrder=desc
    query = """
EXPLAIN ANALYZE
SELECT *
...
"""
    ...
    try:
        ...
        # Run EXPLAIN ANALYZE on list experiences query (using MV)
        execute_query(
            conn,
            query,
            "Benchmarking List Experiences with Materialized View"
        )
