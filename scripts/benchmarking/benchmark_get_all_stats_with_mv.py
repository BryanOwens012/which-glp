#!/usr/bin/env python3
"""
Benchmark: getAllStats using materialized view (via get_drug_stats function)

This script benchmarks the getAllStats query that uses the get_drug_stats()
...
def main():
    ...
    print("Benchmarking getAllStats using materialized view...\n")

    # Query that calls the get_drug_stats function (uses MV)
...
"""
    ...
    try:
        ...
        # Run EXPLAIN ANALYZE on getAllStats query (using MV)
        execute_query(
            conn,
            query,
            "Benchmarking getAllStats with Materialized View"
        )
