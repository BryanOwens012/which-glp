...
const RecommendationsPage = () => {
  ...
  // tRPC mutation for getting recommendations
  ...
  const handleRecommendationClick = (drugName: string) => {
    ...
    // Add first comorbidity as search query if exists
    if (formData.comorbidities && formData.comorbidities.length > 0) {
      params.set("search", formData.comorbidities[0]);
    }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      goalWeight: parseFloat(e.target.value),
                    })
                  }
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        maxBudget: parseFloat(e.target.value) || null,
                      })
                    }
                    className="pl-7"
                  />
                ...
                >
                  ...
                  <div className="mb-4 pb-4 border-b border-border/40">
                    ...
                    <div className="text-3xl font-bold text-primary">
                      {recommendation.expectedWeightLoss.min}-
                      {recommendation.expectedWeightLoss.max}{" "}
                      {recommendation.expectedWeightLoss.unit}
                    </div>
                    <p className="text-xs text-muted-foreground mt-1">
                      Average: {recommendation.expectedWeightLoss.avg}{" "}
                      {recommendation.expectedWeightLoss.unit}
                    </p>
                  </div>
