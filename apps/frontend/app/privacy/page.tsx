    ...
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 pt-24 pb-12 max-w-4xl">
        ...
        <div className="prose prose-sm max-w-none space-y-8">
          <section>
            <p>
              This Privacy Notice for WhichGLP ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
            </p>
            <ul>
              <li>Visit our website at whichglp.com or any website of ours that links to this Privacy Notice</li>
          ...
          <section>
            ...
            <p className="italic">In Short: We may share information in specific situations described in this section.</p>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">5. DO WE OFFER ARTIFICIAL INTELLIGENCE-BASED PRODUCTS?</h2>
            <p className="italic">In Short: We offer products, features, or tools powered by artificial intelligence, machine learning, or similar technologies.</p>
            <p>
          ...
          <section>
            ...
            <p className="italic">In Short: We aim to protect your personal information through a system of organizational and technical security measures.</p>
            <p>
          ...
          <section>
            ...
            <p>
              <strong>Cookies and similar technologies:</strong> Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">10. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">11. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
            <p>
              Based on the applicable laws of your country or state of residence in the US, you may have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. To request to review, update, or delete your personal information, please contact us at contact@whichglp.com.
            </p>
          </section>
        </div>
      </div>
