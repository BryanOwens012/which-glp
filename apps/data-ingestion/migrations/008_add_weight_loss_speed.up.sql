-- Migration: Add weight loss speed calculations to denormalized view
-- This adds pre-calculated weight loss speed metrics for sorting

-- Drop the existing materialized view
DROP MATERIALIZED VIEW IF EXISTS mv_experiences_denormalized CASCADE;

-- Recreate with additional calculated fields
