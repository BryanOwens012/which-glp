-- Rollback: Remove weight loss speed calculations from denormalized view
-- This restores the previous version of the materialized view

-- Drop the current materialized view
DROP MATERIALIZED VIEW IF EXISTS mv_experiences_denormalized CASCADE;

-- Recreate the previous version without weight loss speed fields
