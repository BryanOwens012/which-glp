-- Migration: Deduplicate experiences view by post_id
-- This ensures each post appears only once in the experiences list
-- Prioritizes post-level extractions over comment-level ones

-- Drop the existing materialized view
DROP MATERIALIZED VIEW IF EXISTS mv_experiences_denormalized CASCADE;

-- Recreate with deduplication logic
